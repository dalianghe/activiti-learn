...
public class ReturnFormat {
    ...
    static {
        ...
        messageMap.put("1006", "[服务器]日期类型格式化异常");
        messageMap.put("1007", "[服务器]网络异常");
    ...
    public static OutputJson retParam(int code, Long count, Object data) {
        OutputJson json = new OutputJson(code, messageMap.get(String.valueOf(code)), count, data);
        return json;
    }
